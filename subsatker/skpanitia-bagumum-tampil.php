                        ...
                        <form action="sknarsum-bagumum-setujui.php" method="POST">
                            ...
                            <table style="width:80%; margin-left:auto;margin-right:auto;" cellspacing="0">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    $qnarasumber = mysqli_query($dbsurat, "SELECT * FROM skpanitia WHERE token='$token'");
                                    while ($dnarasumber = mysqli_fetch_array($qnarasumber)) {
                                        $namapanitia = $dnarasumber['nama'];
                                        $nimpanitia = $dnarasumber['nim'];
                                        $siepanitia = $dnarasumber['siepanitia'];
                                    ?>
                                        <tr>
