                        ...
                        <form method="POST">
                            ...
                            <div class=" row">
                                ...
                                <div class="col">
                                    ...
                                    <button type="submit" formaction="skpeserta-bagumum-setujui.php" class="btn btn-lg btn-block btn-success" onclick="return confirm ('Apakah anda sudah melakukan pengecekan terhadap dokumen ini ?')"><i class="fas fa-save"></i> SIMPAN</button>
                                </div>
                                <div class="col">
                                    <button type="submit" formaction="skpeserta-bagumum-update.php" class="btn btn-lg btn-block btn-warning" onclick="return confirm('Update data ?')"><i class="fas fa-refresh"></i> Update Data</button>
                                </div>
                            </div>
                        </form>
                    </div>
