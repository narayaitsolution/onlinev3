              ...
              <div class="card card-primary">
                ...
                <div class="card-body p-0">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col">
                        <a href="pengajuanbawahan-tampil.php" class="btn btn-secondary btn-block"><i class="fa-solid fa-backward-fast"></i> KEMBALI</a>
                      </div>
                      <div class="col">
                        <a href="surattugas-cetak.php?token=<?= $token; ?>" class="btn btn-success btn-block" target="_blank"><i class="fa-solid fa-print"></i> Cetak Surat Tugas</a>
                      </div>
                    </div>
                  </div>
                </div>
