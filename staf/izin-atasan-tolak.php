...
//update status validasi kabag-tu
...
$pesan = "Yth. " . $namapengaju . "<br/>
		...
		Dengan hormat,
		<br />
        Pengajuan Izin anda di tolak oleh Kepala Bagian Tata Usaha Fakultas Sains dan Teknologi dengan alasan <b>" . $keterangan . "</b>.<br/>
