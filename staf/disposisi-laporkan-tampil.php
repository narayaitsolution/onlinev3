...
$qijinujian = mysqli_query($dbsurat, "SELECT * FROM laporkan WHERE kode='$kode'");
...
$keterangan = $dijinujian['keterangan'];
?>
                                ...
                                <div class="card-body p-0">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="perintah" readonly><?= $keterangan; ?></textarea>
                                            </div>
                                        </div>
                                        <hr>
                                        <form role="form" method="POST" action="disposisi-laporkan-simpan.php" id="my-form">
                                            <input type="hidden" name="kode" value="<?= $kode; ?>">
                                            <div class="row">
                                                <div class="col-12">
                                                    <button name="aksi" id="btn-submit" value="setujui" type="submit" class="btn btn-warning btn-block btn-lg" onclick="return confirm('Tindak Lanjuti ?')"> <i class="fa fa-check"></i> Tindak Lanjuti</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
