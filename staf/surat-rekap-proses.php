...
<head>
    ...
    <title>SAINTEK e-Office - Rekap Surat Dalam Proses</title>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <!-- ijin pkl -->
                        <?php
                        $qpkl = mysqli_query($dbsurat, "SELECT * FROM pkl WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun");
                        ...
                        <!-- ijin magang -->
                        <?php
                        $qmagang = mysqli_query($dbsurat, "SELECT * FROM magang WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun");
                        ...
                        <!-- Delegasi -->
                        <?php
                        $qdelegasi = mysqli_query($dbsurat, "SELECT * FROM delegasi WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun");
                        ...
                        <!-- Surat Keterangan -->
                        <?php
                        $qsuket = mysqli_query($dbsurat, "SELECT * FROM suket WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun");
                    ...
                    <div class="row">
                        <!-- Pengambilan Data -->
                        <?php
                        $qdata = mysqli_query($dbsurat, "SELECT * FROM pengambilandata WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun");
                        ...
                        <!-- ijin observasi -->
                        <?php
                        $qobservasi = mysqli_query($dbsurat, "SELECT * FROM observasi WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun");
                        ...
                        <!-- Penelitian -->
                        <?php
                        $qpenelitian = mysqli_query($dbsurat, "SELECT * FROM ijinpenelitian WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun");
                        ...
                        <!-- Surat Ijin lab -->
                        <?php
                        $qlab = mysqli_query($dbsurat, "SELECT * FROM ijinlab WHERE statuspengajuan= 0 AND prodi='$prodi' AND year(tanggal)=$tahun");
                    ...
                    <div class="row">
                        <!-- Pengajuan SK -->
                        <?php
                        $qnarsum = mysqli_query($dbsurat, "SELECT * FROM sk WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun");
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped text-sm">
                            ...
                            <tbody>
                                ...
                                <!-- PKL-->
                                <?php
                                $query = mysqli_query($dbsurat, "SELECT * FROM pkl WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                ...
                                <!-- Magang-->
                                <?php
                                $query = mysqli_query($dbsurat, "SELECT * FROM magang WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                $jmldata = mysqli_num_rows($query);
                                while ($data = mysqli_fetch_array($query)) {
                                    $nodata = $data['no'];
                                    $tanggal = $data['tanggal'];
                                ...
                                <!-- Delegasi-->
                                <?php
                                $query = mysqli_query($dbsurat, "SELECT * FROM delegasi WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                $jmldata = mysqli_num_rows($query);
                                while ($data = mysqli_fetch_array($query)) {
                                    $nodata = $data['no'];
                                    $tanggal = $data['tanggal'];
                                ...
                                <!-- Suket-->
                                <?php
                                $query = mysqli_query($dbsurat, "SELECT * FROM suket WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                $jmldata = mysqli_num_rows($query);
                                while ($data = mysqli_fetch_array($query)) {
                                    $nodata = $data['no'];
                                    $tanggal = $data['tanggal'];
                                ...
                                <!-- Pengambilan Data-->
                                <?php
                                $query = mysqli_query($dbsurat, "SELECT * FROM pengambilandata WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                $jmldata = mysqli_num_rows($query);
                                while ($data = mysqli_fetch_array($query)) {
                                    $nodata = $data['no'];
                                    $tanggal = $data['tanggal'];
                                ...
                                <!-- Observasi-->
                                <?php
                                $query = mysqli_query($dbsurat, "SELECT * FROM observasi WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                $jmldata = mysqli_num_rows($query);
                                while ($data = mysqli_fetch_array($query)) {
                                    $nodata = $data['no'];
                                    $tanggal = $data['tanggal'];
                                ...
                                <!-- Ijin Penelitian-->
                                <?php
                                $query = mysqli_query($dbsurat, "SELECT * FROM ijinpenelitian WHERE statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                $jmldata = mysqli_num_rows($query);
                                while ($data = mysqli_fetch_array($query)) {
                                    $nodata = $data['no'];
                                    $tanggal = $data['tanggal'];
                                ...
                                <!-- Ijin Lab.-->
                                <?php
                                $query = mysqli_query($dbsurat, "SELECT * FROM ijinlab WHERE statuspengajuan= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                $jmldata = mysqli_num_rows($query);
                                while ($data = mysqli_fetch_array($query)) {
                                    $nodata = $data['no'];
                                    $tanggal = $data['tanggal'];
                                ...
                                <!-- SK Narsum-->
                                <?php
                                $qnarsum = mysqli_query($dbsurat, "SELECT * FROM sk WHERE jenissk='narasumber' AND statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                ...
                                <!-- SK Panitia-->
                                <?php
                                $qnarsum = mysqli_query($dbsurat, "SELECT * FROM sk WHERE jenissk='panitia' AND statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                $jmldata = mysqli_num_rows($qnarsum);
                                while ($data = mysqli_fetch_array($qnarsum)) {
                                    $nodata = $data['no'];
                                    $tanggal = $data['tanggal'];
                                ...
                                <!-- SK Peserta-->
                                <?php
                                $qnarsum = mysqli_query($dbsurat, "SELECT * FROM sk WHERE jenissk='peserta' AND statussurat= 0 AND prodi='$prodi' AND year(tanggal)=$tahun ORDER BY prodi ASC, tanggal DESC");
                                $jmldata = mysqli_num_rows($qnarsum);
                                while ($data = mysqli_fetch_array($qnarsum)) {
                                    $nodata = $data['no'];
                                    $tanggal = $data['tanggal'];
