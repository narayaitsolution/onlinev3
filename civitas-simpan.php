...
if ($suhu >= 37.3) {
    ...
    $stmt = $dbsurat->prepare("INSERT INTO masukfakultas (tanggal, nim, nama, prodi, hakakses,suhu, keperluan, jammasuk)
                                VALUES (?,?,?,?,?,?,?,?)");
    $stmt->bind_param("ssssssss", $tanggal, $nim, $nama, $prodi, $hakakses, $suhu, $keperluan, $tanggal);
    $stmt->execute();
