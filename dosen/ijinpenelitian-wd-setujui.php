...
$qurutan = mysqli_query($dbsurat, "SELECT * FROM ijinpenelitian WHERE year(tanggal)=$tahun");
...
$sql1 = mysqli_query($dbsurat, "SELECT * FROM ijinpenelitian WHERE token='$token'");
