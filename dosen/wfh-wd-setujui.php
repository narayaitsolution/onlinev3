...
$pesan = "Yth. " . $namadosen . "<br/>
        ...
        <br/>
        <a href='https://eoffice.saintek.uin-malang.ac.id/dosen/wfh-cetakrk.php?nodata=$nodata' style=' background-color: #0045CE;border: none;color: white;padding: 8px 16px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;'>Cetak Rencana Kerja</a><br/>
        <br/>
		<a href='https://eoffice.saintek.uin-malang.ac.id/dosen/wfh-cetakst.php?nodata=$nodata' style=' background-color: #0045CE;border: none;color: white;padding: 8px 16px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;'>Cetak Surat Tugas</a><br/>
		<br/>
        atau silahkan mencetak melalui website SAINTEK Online di <a href='https://eoffice.saintek.uin-malang.ac.id/'>https://eoffice.saintek.uin-malang.ac.id/</a> apabila tombol diatas tidak berfungsi.<br/>
        <br/>
