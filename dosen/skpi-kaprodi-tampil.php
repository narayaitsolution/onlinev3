                                ...
                                <div class="card-body p-0">
                                    <div class="card-body text-sm">
                                        <form role="form" id="my-form" method="POST" action="skpi-setujui.php">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <button name="aksi" id="btn-submit" value="setujui" type="submit" formaction="skpi-kaprodi-setujui.php" class="btn btn-success btn-block" onclick="return confirm('Apakah anda menyetujui pengajuan ini ?')"> <i class="fa fa-check"></i> Setujui</button>
                                                </div>
                                                <div class="col-lg-6">
