...
$qmhs = mysqli_query($dbsurat, "SELECT * FROM skpi_prestasipenghargaan WHERE nim='$nim' AND verifikator3='$nip'");
                                ...
                                <div class="card-body p-0">
                                    <div class="card-body text-sm">
                                        <form role="form" id="my-form" method="POST" action="skpi-setujui.php">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <button name="aksi" id="btn-submit" value="setujui" type="submit" formaction="skpi-wd-setujui.php" class="btn btn-success btn-block" onclick="return confirm('Apakah anda menyetujui pengajuan ini ?')"> <i class="fa fa-check"></i> Setujui</button>
                                                </div>
                                                <div class="col-lg-6">
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            ...
                                                            <button name="aksi" value="tolak" type="submit" formaction="skpi-wd-tolak.php" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin akan menolak pengajuan ini ?')"> <i class="fa fa-times"></i> Tolak</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
