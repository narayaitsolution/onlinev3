        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Kinerja <?= namadosen($dbsurat, $nipbawahan); ?></h1>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <?php
            //sesuai tusi
            $qjmlkinerjatusi = mysqli_query($dbsurat, "SELECT * FROM kinerja WHERE nip='$nipbawahan' AND jeniskerja='TUSI'");
            $jjmlkinerjatusi = mysqli_num_rows($qjmlkinerjatusi);
            //tisak sesuai tusi
            $qjmlkinerjanontusi = mysqli_query($dbsurat, "SELECT * FROM kinerja WHERE nip='$nipbawahan' AND jeniskerja='Non-TUSI'");
            $jjmlkinerjanontusi = mysqli_num_rows($qjmlkinerjanontusi);
            //tisak sesuai tusi
            $qjmlkinerjask = mysqli_query($dbsurat, "SELECT * FROM kinerja WHERE nip='$nipbawahan' AND jeniskerja='SK'");
            $jjmlkinerjask = mysqli_num_rows($qjmlkinerjask);
            //jamkerja
            $totalkerja = 0;
            $qjamkerja = mysqli_query($dbsurat, "SELECT * FROM kinerja WHERE nip='$nipbawahan'");
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-hover text-sm">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                $query = mysqli_query($dbsurat, "SELECT * FROM kinerja WHERE nip='$nipbawahan' order by tglkerja desc");
