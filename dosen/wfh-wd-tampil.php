...
<body class="hold-transition sidebar-mini text-sm">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            $verifikatorprodi = $dwfh['verifikatorprodi'];
            $verifikasiprodi = $dwfh['verifikasiprodi'];
            $tglverifikasiprodi = $dwfh['tglverifikasiprodi'];
            ?>
                                ...
                                <div class="card-body p-0">
                                    <div class="card-body">
                                            ...
                                            <div class="col-sm-10">
                                                <table id="example3" class="table table-bordered table-hover text-sm">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>1</td>
                                                            <td><?= namadosen($dbsurat, $verifikatorprodi); ?></td>
                                                            <td>Atasan Langsung</td>
                                                            <td><?php if ($verifikasiprodi == 1) {
                                                                    echo 'Disetujui';
                                                                } elseif ($validasi2 == 2) {
                                                                    echo 'Ditolak';
                                                                } else {
                                                            ...
                                                            <td><?= tgljam_indo($tglverifikasiprodi); ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        ...
                                        <form role="form" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <button name="aksi" value="setujui" type="submit" formaction="wfh-wd-setujui.php" class="btn btn-success btn-block btn-lg" onclick="return confirm('Apakah anda menyetujui pengajuan ini ?')"> <i class="fa fa-check"></i> Setujui</button>
                                                </div>
                                                <div class="col-6">
