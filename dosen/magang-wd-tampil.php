...
<body class="hold-transition sidebar-mini text-sm">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            $validator2 = $dmagang['validator2'];
            $tglvalidasi2 = $dmagang['tglvalidasi2'];
            $validasi2 = $dmagang['validasi2'];
                                ...
                                <div class="card-body p-0">
                                    <div class="card-body">
                                        ...
                                        <form role="form" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <button name="aksi" value="setujui" type="submit" formaction="magang-wd-setujui.php" class="btn btn-success btn-block btn-lg" onclick="return confirm('Apakah anda menyetujui pengajuan ini ?')"> <i class="fa fa-check"></i> Setujui</button>
                                                </div>
                                                <div class="col-6">
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            ...
                                                            <button name="aksi" value="tolak" type="submit" formaction="magang-wd-tolak.php" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin akan menolak pengajuan ini ?')"> <i class="fa fa-times"></i> Tolak</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
