                                ...
                                <div class="card-body p-0">
                                    <div class="card-body">
                                                ...
                                                <div class="card-body">
                                                    <table id="example1" class="table table-bordered table-hover text-sm">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $nourut = 1;
                                                            $qnarsum = mysqli_query($dbsurat, "SELECT * FROM skpeserta WHERE token='$token'");
                                                            while ($dnarsum = mysqli_fetch_array($qnarsum)) {
                                                                $namapeserta = $dnarsum['nama'];
                                                                $nimpeserta = $dnarsum['nim'];
                                                            ?>
                                                                <tr>
                                                                    <td>
                                                                        <?= $nourut; ?>
                                        ...
                                        <form role="form" method="POST" id="my-form">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <button name="aksi" id="btn-submit" value="setujui" type="submit" formaction="skpeserta-wd-setujui.php" class="btn btn-success btn-block btn-lg" onclick="return confirm('Apakah anda menyetujui pengajuan ini ?')"> <i class="fa fa-check"></i> SETUJUI</button>
                                                </div>
                                                <div class="col-6">
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            ...
                                                            <button name="aksi" id="btn-submit" value="tolak" type="submit" formaction="skpeserta-wd-tolak.php" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin akan menolak pengajuan ini ?')"> <i class="fa fa-times"></i> Tolak</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
