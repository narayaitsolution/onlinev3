    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <hr>
                Silahkan klik tombol ini apabila sudah keluar dari fakultas
                <hr>
                <a href="civitas-keluar.php" class="btn btn-primary btn-lg btn-block">KELUAR <i class="fa-solid fa-right-to-bracket"></i></a>
            </div>
        </div>
    </div>
