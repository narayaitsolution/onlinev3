                                    ...
                                    <div class="card-body">
                                        <form action="peminjamanalat-simpan.php" method="POST" id="my-form">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="pimpinaninstansi" name="pimpinaninstansi" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" class="form-control" id="jumlahalat" name="jumlahalat" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
