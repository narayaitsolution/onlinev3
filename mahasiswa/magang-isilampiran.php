                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-striped" id="example2">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = mysqli_query($dbsurat, "SELECT * FROM magang WHERE no='$nodata'");
                                    ...
                                    if ($lampiran <> '') {
                                    ?>
                                        <a href="magang-ajukan.php?nodata=<?= $nodata; ?>" class="btn btn-success btn-block" onclick="return confirm ('Saya menyatakan kebenaran data yang saya kirimkan')"><i class="fa fa-file-upload "></i> Ajukan Surat Pengantar </a>
                                    <?php
                                    } else {
                                    ?>
