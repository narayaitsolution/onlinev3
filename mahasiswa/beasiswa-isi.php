                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Pengajuan Rekomendasi Beasiswa</h3>
                                ...
                                <div class="card-body p-0">
                                    <div class="card-body">
                                        <form action="beasiswa-simpan.php" method="POST" id="my-form">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="pemberibeasiswa" name="pemberibeasiswa" required>
                                                </div>
                                            </div>
                                            <hr>
