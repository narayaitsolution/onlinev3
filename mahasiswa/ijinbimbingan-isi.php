                                ...
                                <div class="card-body p-0">
                                    <div class="card-body">
                                        <form action="ijinbimbingan-simpan.php" enctype="multipart/form-data" method="POST" id="my-form">
                                            ...
                                            <div class="form-group row">
                                                <label for="lampiran1" class="col-sm-2 col-form-label">
                                                    Surat Izin Orang Tua
                                                    <a href="../doc/lamp2.docx" class="btn btn-success btn-sm py-0" style="font-size: 0.8em;" target="_blank">Download Format</a>
                                                </label>
                                                <div class="col-sm-10">
                                                    <input type="file" class="form-control" id="lampiran1" name="lampiran1" accept=".jpg,.jpeg" required>
                                                    <small style="color:red">File Type JPG/JPEG ukuran maksimal 1MB</small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="lampiran2" class="col-sm-2 col-form-label">
                                                    Persetujuan Dosen Pembimbing
                                                    <a href="../doc/lamp3.docx" class="btn btn-success btn-sm py-0" style="font-size: 0.8em;" target="_blank">Download Format</a>
                                                </label>
                                                <div class="col-sm-10">
