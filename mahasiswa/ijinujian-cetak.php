...
$datamhs = mysqli_query($dbsurat, "SELECT * FROM ijinujian WHERE token='$token'");
...
<font face="Times" size="12">
    ...
    <table table style="width:80%; margin-left:auto;margin-right:auto;" cellspacing="0" border="0">
        <tbody>
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="4" align="justify">Untuk melaksanakan ujian Skripsi / Tugas Akhir di Program Studi <?= $prodi; ?> Fakulas Sains dan Teknologi UIN Maulana Malik Ibrahim Malang pada tanggal <?= tgl_indo($tglmulai); ?>.</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
